 ...
 */
package com.bist.elasticsearch.jetty.plugin;

import org.elasticsearch.monitor.jvm.JvmInfo;

import java.io.InputStream;
import java.lang.Exception;import java.lang.String;import java.lang.StringBuilder;import java.lang.System;import java.text.SimpleDateFormat;
...
public class Version {
    ...
    static {
        ...
        try {
            InputStream stream = Version.class.getClassLoader().getResourceAsStream("com/bist/elasticsearch/plugin/jetty/version.properties");
            props.load(stream);
            stream.close();
        } catch (Exception e) {
            // ignore
