...
import com.bist.elasticsearch.jetty.JettyHttpServerRestChannel;
import com.bist.elasticsearch.jetty.JettyHttpServerRestRequest;
import com.bist.elasticsearch.jetty.JettyHttpServerTransport;
...
/*        if(authentication == Authentication.NOT_CHECKED || authentication == Authentication.UNAUTHENTICATED) {
            response.sendRedirect("/kibana/Index.html");
            return;
        }*/

//        logger.info("Elastic Querying:"+target);
